...
if(isset($_POST['submit']) && $_POST['submit']=='submit')	{
  	...
  	$query="select username from admin_login_credentials where username='$username'";
  ...
  if(count($completeError)>0) {?>
	...
	$dbName="BloodConnect";
	$query="insert into admin_login_credentials(username,password,blood_bank_name,email,phone_number,street_address,street_line,city,state,zipcode,country,admin_name) values ('$username','$password','$blood_bank_name','$email','$phone_number','$street_address','$street_line','$city','$state','$zipcode','$country','$admin_name')";
	$result=mysqli_query($conn,$query) or die(mysqli_error());
	$_SESSION['username']=$username;
...
<div class="container">
	...
	<div class="heading">
		<h1><center>Sign Up for Admins</center></h1>
	</div>
		<div class="container_1">
			<div class="heading">
				<h2><center>Please Enter Admin Details</center></h2>
			</div>		
					...
					<li>
						...
						<li> 
							...
							<div class="form-input add">
								...
								<span class="form-sub-label">
									<input type="text" name="zipcode" id = "zip_code" placeholder=" " required>
